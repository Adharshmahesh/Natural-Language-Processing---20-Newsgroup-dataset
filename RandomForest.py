...
pipeline = Pipeline([('tf_id', TfidfVectorizer(stop_words = "english")), ('clf', RandomForestClassifier())])
...
clf = Pipeline([('tfidf', TfidfVectorizer(stop_words = "english")),('clf', RandomForestClassifier(bootstrap=True, ccp_alpha=0.0,
